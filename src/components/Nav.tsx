...
export default function Nav() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-line-soft bg-[rgba(8,11,22,0.72)] backdrop-blur-[14px]">
      <nav className="wrap flex h-16 items-center justify-between gap-4">
        ...
        <ul className="hidden items-center gap-8 min-[761px]:flex">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-lg border border-line min-[761px]:hidden"
          >
            <svg
              viewBox="0 0 20 20"
              className="h-5 w-5"
      ...
      {open && (
        <div
          id="mobile-menu"
          className="border-t border-line-soft bg-ink-2 min-[761px]:hidden"
        >
